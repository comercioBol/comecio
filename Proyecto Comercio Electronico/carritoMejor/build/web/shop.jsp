...
<body>
	...
	<section id="advertisement">
		<div class="container">
                    <center><img src="images/shop/logo.jpg" alt="" /></center>
		</div>
	</section>
			...
			<div class="row">
					...
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--categoria de productos-->
							...
							<div class="panel panel-default">
								...
								<div id="mens" class="panel-collapse collapse">
									<div class="panel-body">
										<ul>
											<li><a href="">Tolan</a></li>
											<li><a href="">Jeans</a></li>
											<li><a href="">Clasicos</a></li>
											<li><a href="">Cegarretes</a></li>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#">Ropa de bebes</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#">Ropa de niñas/os</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#">Linceria</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#">Trajes</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#">Ropa de cholitas</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#">Vestidos</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#">Chamarras</a></h4>
								</div>
							</div>
						</div><!--/categoria de los productos-->
					
						<div class="brands_products"><!--bandas de productos-->
							<h2>Ventas</h2>
						...
						<div class="price-range"><!--price-range-->
							...
							<div class="well">
								 ...
								 <b>Bs 0</b> <b class="pull-right">Bs 5500</b>
							</div>
						</div><!--/price-range-->
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--productos-->
						<h2 class="title text-center">Productos a la venta</h2>
