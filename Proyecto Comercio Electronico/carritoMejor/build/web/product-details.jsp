			...
			<div class="row">
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#">Chamaras</a></h4>
								</div>
							</div>
				...
				<div class="col-sm-9 padding-right">
					<div class="product-details"><!--product-details-->
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<p>Web : <%= producto.getId()%></p>
								<img src="images/product-details/rating.png" alt="" />
                                                                <form action="agregarproducto" method="post">
								<span>
									<span> Bs <%= producto.getPrecio()%></span>
					...
					<div class="category-tab shop-details-tab"><!--category-tab-->
						<div class="col-sm-12">
							<ul class="nav nav-tabs">
								...
								<li><a href="#companyprofile" data-toggle="tab">Productos de la Compañia</a></li>
								<li><a href="#tag" data-toggle="tab">Tipos de procucto</a></li>
								<li class="active"><a href="#reviews" data-toggle="tab">Recervaciones ( )</a></li>
							</ul>
						</div>
					...
					<div class="recommended_items"><!--recommended_items-->
						<h2 class="title text-center">Otras opciones</h2>
